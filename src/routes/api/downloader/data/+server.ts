...
export const GET = (async ({ }) => {
  Promise.all(Array.from({ length: 114 }, async (x, i: number) => {
    ...
    wordAR = await (await fetch(`https://quranwbw.com/assets/data/${i}/word-translations/arabic.json?v=30`)).json();
    ayaID = await (await fetch(`https://quranwbw.com/assets/data/${i}/ayah-translations/id.bahasa.json?v=30`)).json();
    wordID = await (await fetch(`https://quranwbw.com/assets/data/${i}/word-translations/indonesian.json?v=30`)).json();
